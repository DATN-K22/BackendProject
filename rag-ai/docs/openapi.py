...
OPENAPI_SPEC: dict = {
    ...
    "info": {
        ...
        "description": (
            "A2A-compatible Retrieval-Augmented Generation service.\n\n"
            "Incoming requests are expected to be forwarded by the API gateway "
        ...
        "schemas": {
            "A2APart": {
                ...
                "properties": {
                    ...
                    "text": {"type": "string", "example": "Summarize this policy document"},
                },
            },
            "A2AMessage": {
                "type": "object",
                ...
                "properties": {
                    ...
                    "contextId": {
                        ...
                        "example": "c9f88dd0-cbea-4d6f-8d16-a8f2919fcb68",
                    },
                },
            },
            "MessageSendRequest": {
